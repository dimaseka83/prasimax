<template>
    <div>
         <v-container fluid class=" white--text background-footer pa-16">
            ...
            <v-row>
                <v-col>
                    <p class="subtitle">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere non earum veniam sapiente necessitatibus mollitia omnis harum ullam asperiores nam voluptatibus cum impedit tempore quibusdam distinctio officiis blanditiis, officia rem!</p>
                ...
                <v-col>
                    ...
                    <v-row class="mt-16">
                        <v-col md="4" v-for="(social, i) in socials" :key="i + 'social2'">
                            <v-btn text><v-icon x-large color="white">{{ social.icon }}</v-icon></v-btn>
                        </v-col>
                    </v-row>
                </v-col>
                <v-col>
                ...
                <v-col>
                    ...
                    <p>
                        Dapatkan informasi dan berita terbaru dari perusahaan kami. seperti berita, makalah, dan lain-lain.
                    </p>
         ...
         <v-container fluid class="background-footer-bottom white--text">
            <div class="d-flex">
                <span class="mr-auto">&copy; PT Prasimax Inovasi Teknologi, 2010 - {{ getYears }}, All rights reserved</span>
                <span class="text-capitalize">Bergabung dengan Kami</span>
                <v-btn x-small text v-for="(social, i) in socials" :key="i + 'social'"><v-icon color="white">{{ social.icon }}</v-icon></v-btn>
            </div>
         </v-container>
    </div>
</template>
