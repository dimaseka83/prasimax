<template>
    <v-app>
        ...
        <v-img gradient="to top right, rgba(0, 57, 94, 1), rgba(255, 255, 255, 0)"
            src="@/assets/images/static/hubungilanding.svg" :height="height">
            ...
            <v-row class="my-10">
                <v-col cols="4" v-for="i in 3" :key="i">
                    <v-card rounded="xl" elevation="12">
                        <v-img gradient="to top right, rgba(0, 57, 94, 1), rgba(255, 255, 255, 0)"
                            src="@/assets/images/dummy/board.jpg" :height="height-300">
                        </v-img>
                ...
                <v-col cols="6">
                    <v-card flat class="ma-16 blue--text">
                        <v-container>
                            ...
                            <p class="title mt-5">Untuk menjangkau kantor kami, ada beberapa pilihan moda transportasi
